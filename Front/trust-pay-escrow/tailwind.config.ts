    ...
    extend: {
      ...
      keyframes: {
        ...
        glow: {
          ...
          to: { boxShadow: '0 0 30px rgba(99,102,241,0.6), 0 0 60px rgba(168,85,247,0.2)' },
        },
        slideUp: {
      ...
      fontSize: {
        'title-lg': ['3rem', { lineHeight: '1.2', fontWeight: '900' }],
        'title-md': ['2.25rem', { lineHeight: '1.2', fontWeight: '900' }],
        'title-sm': ['1.875rem', { lineHeight: '1.2', fontWeight: '700' }],
